...
set_property PACKAGE_PIN K17 [get_ports {QspiMOSI}]
set_property IOSTANDARD LVCMOS33 [get_ports {QspiMOSI}]
#Bank = CONFIG, Pin name = IO_L1N_T0_D01_DIN_14,			Sch name = QSPI_DQ1
set_property PACKAGE_PIN K18 [get_ports {QspiMISO}]
set_property IOSTANDARD LVCMOS33 [get_ports {QspiMISO}]
